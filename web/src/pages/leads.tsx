...
export default function LeadsPage() {
  const { threads, suggestions, failed, leads, outbox, mailbox, user, setUser, confirm, dismiss, updateLead } =
    useData();
  ...
  return (
    <AppShell
      sidebar={<Sidebar counts={counts} activeFolder="all" inInbox={false} mailbox={mailbox} />}
      main={
        <LeadsBoard
