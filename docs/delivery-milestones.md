...
| M6 总交付 | infra 账本、图和实际部署版本一致；附验收证据 | infra PR #232–#240 已合并；PR #241 更新六台设备与生产图，CI 已通过但尚未合并。Aimail 部署及 Spark 权限证据已记录。仍待双人权限、真实业务流程验收及旧回退引用清理。 |
...
- 2026-09-26 CST：infra PR #241 的 CI 已通过，尚未合并；它更新生产资产清单和生产图，不代表剩余业务验收完成。阿里云 OA 健康恢复且安全门禁通过；与 Aimail 项目范围分开记录。
